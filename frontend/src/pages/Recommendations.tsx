...
const Recommendations: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError(null);
    try {
      // For now, just call getRecommendations (update this to POST later)
  ...
  return (
    <div style={{ padding: '2.5rem', maxWidth: 700, margin: '2rem auto', background: 'white', borderRadius: '16px', boxShadow: '0 4px 24px rgba(25, 118, 210, 0.10)', textAlign: 'center' }}>
      ...
      {loading ? (
        ...
        <ul style={{ margin: '1.5rem 0', fontSize: '1.1rem', color: '#444', textAlign: 'left', display: 'inline-block', lineHeight: 2 }}>
